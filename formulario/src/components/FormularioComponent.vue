...
export default {
  ...
  directives: { maska: vMaska, moment },
  data: () => ({
    cursos: [
      { id: 1, curso: "Bancos de dados" },
      { id: 2, curso: "Desenvolvimento Web" },
      { id: 3, curso: "Desenvolvimento Mobile" },
      { id: 4, curso: "Desenvolvimento de Games" },
    ],
    form: {},
    formEstadoInicial: {
      nome: "Jorge",
      ...
      cor: "#6c757d",
      alcance: 5,
      escondido: "Input está escondido",
      descricao: "",
      curso: "",
    },
  }),
